      ...
      <div class="steps">
        ...
        <Transition name="step">
          <div v-if="visibleSteps >= 1" class="step-card">
            ...
            <p class="step-text">翻开卡片，看看藏着什么</p>
          </div>
        </Transition>
        ...
        <Transition name="step">
          <div v-if="visibleSteps >= 2" class="step-card">
            ...
            <p class="step-text">找到同一组的两张，收回回忆</p>
          </div>
        </Transition>
...
.flip-anim .mini-inner {
  animation: miniFlip 2.8s ease-in-out infinite;
}
.flip-anim.delay-1 .mini-inner {
